...
<main class="nsb-search-article-form flex-fill mt-4">
    <div class="container">
        <h1 class="nsb-titulo text-center">Compra el artículo que estás buscando de Shein</h1>
        <p class="nsb-parrafo my-5 text-center">Introduce el enlace del artículo que deseas comprar en Shein y nosotros
            te ayudamos a encontrarlo</p>
        <form action="/articulo" method="post" id="form_buscar_articulo">
            @csrf
            <small class="nsb-texto-ayuda">¿cómo hacer esto?</small>
            <div class="input-group mt-1">
                <input type="text" name="input_url_articulo" id="input_url_articulo"
                       placeholder="Introduce el enlace del artículo" value="{{ old('input_url_articulo') }}">
...
<div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true" id="modal-loader" style="background-color:#000000bf">
    <div class="modal-dialog modal-dialog-centered">
...
<script>
    $(function () {
        ...
        $("#button_reintentar").click(function(){
            $("#modal-loader").modal('show')
        })
