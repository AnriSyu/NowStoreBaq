            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="/rginsc" id="form_rginsc">
                        ...
                        <input type="text" class="form-control mb-3" id="input_correo">
                        <label for="input_clave">Contraseña:</label>
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" id="input_clave">
                        ...
                        <button type="submit" class="btn nsb-btn nsb-btn-primario mt-4" id="button_continuar" style="width:100%" >CONTINUAR</button>
                    </form>
                    <hr>
                    <button type="button" class="btn nsb-btn my-4" style="width: 100%;border:1px solid #e2e2e2"><i class="fab fa-google"></i> Continuar con Google</button>
                </div>
            </div>
        </div>
    </div>
